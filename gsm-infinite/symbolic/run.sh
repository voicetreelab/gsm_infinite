...
if [[ "$run_sampling" == true ]]; then
    OPENAI_BASE_URL=$SAMPLER_OPENAI_BASE_URL
    OPENAI_API_KEY=$SAMPLER_OPENAI_API_KEY
...
if [[ "$run_evaluation" == true ]]; then
    OPENAI_BASE_URL=$EVAL_OPENAI_BASE_URL
